...
* **Code:**
  ...
  ```
* **Metadata:** `{kind:change, importance:low, scope:(global)}`
...
* **Metadata:** `{kind:addition, importance:highlight, scope:Object}`
...
* **Metadata:** `{kind:change, importance:low, scope:Kernel}`
...
* **Code:**
  ...
  ```
* **Metadata:** `{kind:addition, importance:medium, scope:Kernel}`
...
* **Code:**
  ...
  # => 1.5
  ```
* **Metadata:** `{kind:change, importance:low, scope:Module}`
...
* **Code:**
  ...
  ```
* **Metadata:** `{kind:addition, importance:low, scope:Method}`
...
* **Code:**
  ...
  ```
* **Metadata:** `{kind:addition, importance:medium, scope:Integer}`
...
* **Code:**
  ...
  ```
* **Metadata:** `{kind:addition, importance:medium, scope:String}`
